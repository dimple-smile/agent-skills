...
【图片占位:请在此处上传 simulator.png(说明:傅里叶变换图解页里的交互模拟器:探针频率可调,频谱柱实时长出来)】
...
【图片占位:请在此处上传 pipeline.png(说明:aha 的完整流水线(自制示意图):一句话 → 七层生成 → 质量门 → 书架 → 导出/分享)】
...
【图片占位:请在此处上传 fable.png(说明:寓言《查房》全文与「故事↔机制」的映射)】
