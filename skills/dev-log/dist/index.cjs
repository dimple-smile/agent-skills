...
var LOG_FILE = import_path.default.join(getDirname(), "dev-logs.json");
var PID_FILE = import_path.default.join(getDirname(), "pid.txt");
var PORT_FILE = import_path.default.join(getDirname(), "port.txt");
var TUNNEL_URL_FILE = import_path.default.join(getDirname(), "tunnel-url.txt");
